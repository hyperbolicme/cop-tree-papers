...
%       First consider $R$ being equal to $S_1 \cap S_2$. 
%       From principle of inclusion exclusion, we know that $|S_1 \cap
%       S_2 \cap R' \cap R''| = |S_1|+|S_2|+|R'|+|R''|-|S_1 \cap
%       S_2|-|S_1 \cap R'|-|S_1 \cap R''|-|S_2 \cap R'|-|S_2 \cap
%       R''|-|R' \cap R''|+|S_1 \cap S_2 \cap R'|+|S_1 \cap S_2 \cap
%       R''|+|S_1 \cap R' \cap R''|+|S_2 \cap R' \cap R''|-|S_1 \cup S_2
%       \cup R' \cup R''|$
