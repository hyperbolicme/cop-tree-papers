...
\begin{abstract}
  ...
  find a feasible tree path labeling of a given set system when $T$ is
  a {\em $k$-subdivided star}, set system has a single containment
  tree of overlap components and set size is limited to at most $k+2$.
